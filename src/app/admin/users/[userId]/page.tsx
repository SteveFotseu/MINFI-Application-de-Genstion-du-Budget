...
//
// v2 : utilise désormais <AdminSidebar /> partagé.
// ============================================================
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
                ...
                <div style={{ background: '#fff', borderRadius: 14, border: '1px solid #E8ECF0', padding: 20, boxShadow: '0 2px 12px rgba(0,0,0,.05)' }}>
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
                    ...
                    {user.agentId && (
                      <Link href={APP_ROUTES.ADMIN_AGENT_DETAIL(user.agentId)} style={{ textDecoration: 'none' }}>
                        <button style={actionBtnStyle('#1D4ED8', '#EFF6FF', '#BFDBFE')}>
                          <IconID /> Voir la fiche agent
                        </button>
                      </Link>
                    )}
                  ...
                  {user.mandats.length === 0 ? (
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
                      {user.mandats.map((m, idx) => (
                        <div key={m.mandatId} style={{ border: '1px solid #E8ECF0', borderRadius: 12, padding: 16, background: m.actif ? '#fff' : '#FAFBFC' }}>
